...
HD_PWD='C:/Users/ALLAN/Documents/morse_decoder/morse_decoder_proj/morse_decoder_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Morse.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Morse.tcl -notrace
